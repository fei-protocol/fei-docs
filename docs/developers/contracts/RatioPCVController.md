...
```javascript
function withdrawRatio(address,address,uint256) nonpayable
```
...
| Param | Type | Notes |
| ----- | ---- | ----- |
| pcvDeposit | address | PCV deposit to withdraw from |
...
```javascript
function withdrawRatioERC20(address,address,address,uint256) nonpayable
```
